...
public class MongoDatabaseManager implements Closeable {
    ...
    public static String collectionLogName = "logs";
    public static String collectionFileName = "files";
    ...
    public MongoCollection<LogEntry> getLogsCollection() {
        return getCollection(collectionLogName, LogEntry.class);
    }

    public MongoCollection<LogFile> getFilesCollection() {
        return getCollection(collectionFileName, LogFile.class);
    }
